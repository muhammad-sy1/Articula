...
const LatestArticles = ({ anArticle }) => {
  ...
  return (
    <>
      <div className="lg:hover:shadow-(--shadow-gray-800) bg-white transition-shadow duration-200 ease-in-out xl:col-span-2 lg:col-span-3 md:col-span-3 sm:col-span-5 col-span-10">
